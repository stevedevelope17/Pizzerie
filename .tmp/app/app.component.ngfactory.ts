...
class _View_MyApp0 extends import1.AppView<import0.MyApp> {
  ...
  _text_1:any;
  _el_2:any;
  _Header_2_3:import13.Wrapper_Header;
  _text_3:any;
  _el_4:any;
  /*private*/ _appEl_4:import3.AppElement;
  _Toolbar_4_4:import13.Wrapper_Toolbar;
  _text_5:any;
  _el_6:any;
  /*private*/ _appEl_6:import3.AppElement;
  _ToolbarTitle_6_4:import14.Wrapper_ToolbarTitle;
  _text_7:any;
  _text_8:any;
  _text_9:any;
  _text_10:any;
  ...
  _text_12:any;
  _el_13:any;
  _List_13_3:import16.Wrapper_List;
  _text_14:any;
  _anchor_15:any;
  ...
  _Nav_21_4:import18.Wrapper_Nav;
  /*private*/ _expr_1:any;
  /*private*/ _expr_2:any;
  constructor(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import3.AppElement) {
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._Menu_0_4 = new import12.Wrapper_Menu(this.parentInjector.get(import19.MenuController),new import20.ElementRef(this._el_0),this.parentInjector.get(import21.Config),this.parentInjector.get(import8.Platform),this.renderer,this.parentInjector.get(import22.Keyboard),this.parentInjector.get(import23.NgZone),this.parentInjector.get(import24.GestureController));
    ...
    this._Header_2_3 = new import13.Wrapper_Header(this.parentInjector.get(import21.Config),new import20.ElementRef(this._el_2),this.renderer,this.parentInjector.get(import25.ViewController,(null as any)));
    ...
    var compView_4:any = import13.viewFactory_Toolbar0(this.viewUtils,this.injector(4),this._appEl_4);
    this._Toolbar_4_4 = new import13.Wrapper_Toolbar(this.parentInjector.get(import25.ViewController,(null as any)),this.parentInjector.get(import21.Config),new import20.ElementRef(this._el_4),this.renderer);
    ...
    var compView_6:any = import14.viewFactory_ToolbarTitle0(this.viewUtils,this.injector(6),this._appEl_6);
    this._ToolbarTitle_6_4 = new import14.Wrapper_ToolbarTitle(this.parentInjector.get(import21.Config),new import20.ElementRef(this._el_6),this.renderer,this._Toolbar_4_4.context,this.parentInjector.get(import26.Navbar,(null as any)));
    ...
    this._Content_11_4 = new import15.Wrapper_Content(this.parentInjector.get(import21.Config),new import20.ElementRef(this._el_11),this.renderer,this.parentInjector.get(import27.App),this.parentInjector.get(import22.Keyboard),this.parentInjector.get(import23.NgZone),this.parentInjector.get(import25.ViewController,(null as any)),this.parentInjector.get(import28.Tabs,(null as any)));
    ...
    this._List_13_3 = new import16.Wrapper_List(this.parentInjector.get(import21.Config),new import20.ElementRef(this._el_13),this.renderer,this.parentInjector.get(import24.GestureController));
    ...
    this._NgFor_15_6 = new import17.Wrapper_NgFor(this._appEl_15.vcRef,this._TemplateRef_15_5,this.parentInjector.get(import30.IterableDiffers),this.ref);
...
class _View_MyApp1 extends import1.AppView<any> {
  ...
  createInternal(rootSelector:string):import3.AppElement {
    ...
    this._Item_0_4 = new import42.Wrapper_Item(this.parent.parentInjector.get(import44.Form),this.parent.parentInjector.get(import21.Config),new import20.ElementRef(this._el_0),this.renderer,this.parent.parentInjector.get(import45.ItemReorder,(null as any)));
    this._ItemContent_0_5 = new import42.Wrapper_ItemContent();
    this._MenuClose_0_6 = new import43.Wrapper_MenuClose(this.parent.parentInjector.get(import19.MenuController));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import46.Item) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._Item_0_4.context; }
    if (((token === import46.ItemContent) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._ItemContent_0_5.context; }
    if (((token === import47.MenuClose) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 1)))) { return this._MenuClose_0_6.context; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
